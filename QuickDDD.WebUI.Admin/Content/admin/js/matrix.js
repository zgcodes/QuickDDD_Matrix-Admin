...
/*******弹出表单*********/
function ShowModal(actionUrl, saveActionUrl, param, title) {

    //表单初始化
    $(".modal-title").html(title);
    $("#modal-content").attr("action", saveActionUrl);
...
renderBool = function (obj, data) {
    var html = '';
    if (data === true)
        html = '<i class="icon-ok" style="color:#009000;"></i>';
    else
        html = '<i class="icon-remove" style="color:#bbb; font-size:60%"></i>';
    return html;
}
