...
define('widgets/Call', function (require, exports, module) {
    ...
    WX_Widget.Call = {
        ...
        showWidgetTemplate: function () {
            return [
			'<section class="wCall ${FWidgetId}">',
            '<style>',
            'section.wCall.${FWidgetId} {',
            '  padding: ${FStyle.Margin|padding};',
            '}',
            'section.wCall.${FWidgetId} a {',
            ...
            '}',
            'section.wCall.${FWidgetId} .divicon {',
            '  font-size: ${FStyle.IconSize};',
            '  color: ${FStyle.IconColor};',
            '}',
            'section.wCall.${FWidgetId} .divicon > img {',
            ...
            '}',
            'section.wCall.${FWidgetId} .divtext {',
            ...
            '$${FStyle.CssHtml}',
            '</style>',
            '<a {@if (FData.Title)}href="tel:${FData.Title}"{@/if}>',
        ...
        editWidgetTemplate: [
            ...
            '    <label>电话号码<span class="asterisk">*</span></label><span class="help-inline">（限20位）</span>',
            '    <div class="controls">',
            '        <input class="form-control" type="text" maxlength="20" data-tmpldata="Title" value="$${FData.Title}" placeholder="请输入电话号码">',
            '    </div>',
            '</div>',
            //'<div class="form-group">',
        ...
        styleWidgetTemplate: [
            ...
            '	        <textarea id="txt_html" class="input-xxlarge" rows="15">{@if (FStyle.CssHtml=="")}/*section.wCall.${FWidgetId} { }*/{@else}$${FStyle.CssHtml}{@/if}</textarea>',
            '	    </div>',
            '	</div>',
            '</div>'].join("\n"),
