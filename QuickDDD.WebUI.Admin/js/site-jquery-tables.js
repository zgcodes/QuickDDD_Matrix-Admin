...
$(function () {
    ...
    site.tables = {
        ...
        //czg
        getSelectedOneRowData: function () {
            return controler.getSelectData()[0];
        },
        ...
        ajax: function (options) {
            ...
            return function (request, drawCallback, settings) {
                ...
                //增加查询参数 czg
                var params = fillFilterParams();
                for (item in params) {
                    parmetersData[item] = params[item];
                }
...
function fillFilterParams() {
    ...
    var d = {};
    filterbar.find('[filterField]').each(function (i, v) {
        var val = "";
